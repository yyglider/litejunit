package com.litejunit.v2.textui;

import java.util.*;

import com.litejunit.v2.AssertionFailedError;
import com.litejunit.v2.Test;
import com.litejunit.v2.TestFailure;
import com.litejunit.v2.TestResult;
import com.litejunit.v2.TestSuite;
import com.litejunit.v2.runner.BaseTestRunner;
...
public class TestRunner extends BaseTestRunner {
    ...
    public static void main(String args[]) {
        ...
        try {
            TestResult r = testRunner.start(new String[]{"com.litejunit.v3.sample.CalculatorTest"});
            if (!r.wasSuccessful()) {
                System.exit(-1);
            }
            System.exit(0);
